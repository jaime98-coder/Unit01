...
public class EjercicioExamen02 {
	...
	public static void main(String[] args) {
		...
		// de esta forma si en un futuro cambian los impuestos a aplicar, puedo cambiar
		// directamente
		...
		double impuestos;
		// Declaro la variable para almacenar el salario semanal antes de impuestos
		// (bruto)
		double salarioSemanalBruto;
		// Declaro la variable para almacenar el salario semanal después de impuestos
		// (neto)
		...
		// Calculamos el salario semanal neto
		salarioSemanalNeto = salarioSemanalBruto - salarioSemanalBruto * impuestos;
		// Imprimimos mensaje final,donde indicamos el salario semanal neto.
